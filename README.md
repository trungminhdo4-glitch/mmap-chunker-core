...
|------|----------------:|----------------------:|------------------:|------------------:|
| Single-process reference | — | — | — | 317.5 ms |
| 1 worker | 0.230 ms | 6.8 ms | 488.5 ms | 495.5 ms |
| 2 workers | 0.207 ms | 12.5 ms | 276.2 ms | 290.2 ms |
| 4 workers | 0.201 ms | 20.9 ms | 217.1 ms | 247.1 ms |

All modes processed the same 100,000 records and 11,518,914 bytes and produced
the same value sum. This is an adoption/correctness proof, not a universal
performance claim: Python process startup and JSON decoding dominate this
