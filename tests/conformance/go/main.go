...
func main() {
	...
	if C.mmap_engine_abi_version() != C.uint32_t(0x00010005) ||
		C.mmap_engine_capabilities() != C.uint32_t(255) {
	...
	result := fmt.Sprintf(
		"abi_version=65541;capabilities=255;partition_count=%d;partition_lengths=%s;"+
