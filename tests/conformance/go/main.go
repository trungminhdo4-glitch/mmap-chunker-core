...
func main() {
	...
	if C.mmap_engine_abi_version() != C.uint32_t(0x00010006) ||
		C.mmap_engine_capabilities() != C.uint32_t(511) {
	...
	result := fmt.Sprintf(
		"abi_version=65542;capabilities=511;partition_count=%d;partition_lengths=%s;"+
